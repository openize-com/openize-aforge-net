...
namespace FileFormat.AForge.Imaing.NetStandard.Filters.Base_classes
{
    using System.Collections.Generic;
    using System.Drawing;
    using System.Drawing.Imaging;
    using Image = NetStandard.Image;
    ...
    public abstract class BaseTransformationFilter : IFilter, IFilterInformation
    {
        ...
        public Bitmap Apply( BitmapData imageData )
        {
            ...
            Bitmap dstImage = ( dstPixelFormat == PixelFormat.Format8bppIndexed ) ?
                Image.CreateGrayscaleImage( newSize.Width, newSize.Height ) :
