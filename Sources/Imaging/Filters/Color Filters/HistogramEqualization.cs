...
namespace FileFormat.AForge.Imaing.NetStandard.Filters.Color_Filters
{
    ...
    public class HistogramEqualization : BaseInPlacePartialFilter
    {
        ...
        protected override unsafe void ProcessFilter( UnmanagedImage image, Rectangle rect )
        {
            ...
            if ( image.PixelFormat == PixelFormat.Format8bppIndexed )
            {
                ...
                byte[] equalizedHistogram = this.Equalize( histogram, numberOfPixels );
            ...
            else
            {
                ...
                // calculate new intensity levels
                byte[] equalizedHistogramR = this.Equalize( histogramR, numberOfPixels );
                byte[] equalizedHistogramG = this.Equalize( histogramG, numberOfPixels );
                byte[] equalizedHistogramB = this.Equalize( histogramB, numberOfPixels );
